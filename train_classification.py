...
ROOT_DIR = BASE_DIR
sys.path.append(os.path.join(ROOT_DIR, os.path.join("src", "pointnetPlusPlus")))
...
def main(args):
    ...
    shutil.copy("./src/pointnetPlusPlus/%s.py" % args.model, str(exp_dir))
    shutil.copy("./src/pointnetPlusPlus/utils.py", str(exp_dir))
