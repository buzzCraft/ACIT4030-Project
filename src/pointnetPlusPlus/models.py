...
class get_model(nn.Module):
    def __init__(self, num_class, normal_channel=True):
        ...
        # Set abstraction layers using PointNetSetAbstractionMsg and PointNetSetAbstraction
        ...
        # Fully connected layers with batch normalization and dropout for feature extraction and classification
    ...
    def forward(self, xyz):
        ...
        # Process normal channels if enabled
        ...
        # Apply log softmax function for classification
        x = F.log_softmax(x, -1)
